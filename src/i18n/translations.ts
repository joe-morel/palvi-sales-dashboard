...
export const translations = {
  es: {
    ...
    appSubtitle: 'Informe ejecutivo de métricas',
    datasetLabel: 'Datos',
    rangeLabel: 'Período',
    ...
    metricsStableOrImproving:
      'Las métricas clave están estables o mejoran frente a la semana anterior.',
    vsPreviousWeek: 'vs. semana anterior',
    worseVsPreviousWeek: 'empeoró vs. semana anterior',
    ...
    metricDealsCreated: 'Oportunidades creadas',
    metricDealsWon: 'Oportunidades ganadas',
    metricDealsLost: 'Oportunidades perdidas',
    metricResponseTime: 'Tiempo de respuesta',
    metricAvgDealCycleDays: 'Ciclo de venta',
    metricStaleDeals: 'Oportunidades estancadas',
    metricSupportTickets: 'Tickets de soporte',
    metricSupportResolution: 'Resolución en soporte',
    funnelSectionTitle: 'Salud del embudo',
    funnelSectionSubtitle: 'Volumen del período · conversión por etapa',
    funnelBaseStep: 'Base del embudo',
    funnelFromPrevious: 'desde',
    ...
    trendSeriesDealsWon: 'Oportunidades ganadas',
    noDataInRange: 'Sin datos en el período',
    noFunnelData: 'Sin datos de embudo en el período',
    comparedToPreviousPeriod: 'vs. período anterior',
    semanticColorHint: 'El color indica si la métrica mejoró o empeoró según su dirección.',
    periodTotalLabel: 'en el período',
    exactRangeLabel: 'Rango',
    exactRangeVs: 'vs.',
    footerCreator: 'Creado por',
  ...
  en: {
    ...
    worseVsPreviousWeek: 'worse vs prior week',
    ...
    funnelSectionSubtitle: 'Period volume · stage conversion',
    funnelBaseStep: 'Funnel base',
    funnelFromPrevious: 'from',
    ...
    semanticColorHint:
      'Color shows whether the metric improved or worsened based on its direction.',
    periodTotalLabel: 'in period',
    exactRangeLabel: 'Range',
    exactRangeVs: 'vs',
...
const focusRecoEs: Record<keyof DayMetrics, string> = {
  ...
  leads_created:
    'Monitorea la generación y calificación de demanda; revisa los tiempos de respuesta comprometidos.',
  leads_qualified:
    'Revisa el perfil de cliente ideal y el traspaso de marketing a ventas para calificar mejor.',
  deals_created: 'Asegura volumen de oportunidades: revisa demostraciones agendadas y propuestas.',
  deals_won: 'Refuerza el manual de cierre y elimina fricciones en la negociación.',
  ...
  avg_deal_cycle_days: 'Acorta etapas del embudo y define próximos pasos con fecha.',
  stale_deals:
    'Audita oportunidades sin movimiento; define la siguiente acción o descártalas con criterio.',
  support_tickets_opened:
    'Revisa carga operativa y fricción posventa con soporte y éxito del cliente.',
